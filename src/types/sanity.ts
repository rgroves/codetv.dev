...
// Query: *[_type=="episode" && hidden != true] {    title,    'slug': slug.current,    'collection': *[_type=="collection" && references(^._id)][0].slug.current,    'series': *[_type=="collection" && references(^._id)][0].series->slug.current  }
